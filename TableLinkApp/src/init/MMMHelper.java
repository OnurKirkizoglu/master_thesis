...
/**
 * Helper class used to support easier creation of complex types and instances.
 * <br>
 * Furthermore holds all design space artifacts that are used by the
 * {@link application.LinkApplication}.
 */
public class MMMHelper {
	...
	// TODO: This artifact should be exists as default in design space.
	 ...
	 *            the {@link Workspace}
	 * @param pkg
	 *            the {@link Package} where the complex type will be created
	 * @param name
	 *            the name of the complex type
	 * @param features
	 *            the features of the complex type
	 ...
	 *            the {@link Workspace}
	 * @param pkg
	 *            the {@link Package} where the instance will be created
	 * @param name
	 *            the name of the instance
	 * @param complexType
	 *            the type of the instance
	 * @param instanceValues
	 *            the instance values, which will be set for the features
	 * @return the new created instance
	 */
	public static Artifact createComplexTypeInstance(Workspace ws, Package pkg, String name, Artifact complexType,
	 ...
	 *            the link target
	 * @param linkPackage
	 *            the package where it will be created
	 * @return the new link instance
	 */
	public Artifact createLinkInstance(String linkName, Link link, Artifact source, Artifact target,
			Package linkPackage) {
