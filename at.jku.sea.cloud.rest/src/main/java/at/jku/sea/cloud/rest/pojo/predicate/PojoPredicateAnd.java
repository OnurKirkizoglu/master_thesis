...
@JsonTypeName(value = "AndPredicate")
public class PojoPredicateAnd extends PojoPredicate {
  private PojoPredicate predicate1;
  private PojoPredicate predicate2;

  public PojoPredicateAnd() {
  }

  public PojoPredicateAnd(PojoPredicate predicate1, PojoPredicate predicate2) {
