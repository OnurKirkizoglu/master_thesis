...
@JsonTypeName(value = "VersionCommited")
public class PojoVersionCommited extends PojoWorkspaceChange {

  private PojoPublicVersion version;
  private long oldBaseVersion;
  private PojoChange[] changes;

  public PojoVersionCommited() {
  }

  public PojoVersionCommited(PojoWorkspace workspace, PojoPublicVersion version, PojoChange[] changes, long oldBaseVersion) {
    super(workspace);
