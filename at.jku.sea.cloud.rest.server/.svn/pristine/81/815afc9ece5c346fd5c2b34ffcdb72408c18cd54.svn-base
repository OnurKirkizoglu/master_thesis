...
public class CloudBufferListener implements CloudListener {

  private Queue<Change> eventBuffer = new ConcurrentLinkedQueue<Change>();
  ...
  @Override
  public void workspaceAdded(WorkspaceAdded event) throws RemoteException {
    eventBuffer.offer(event);
  }
